                ...
                <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                    <div class="position-sticky pt-3">
                        <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="blogmanage">
                                    <i class="fas fa-fw fa-palette fs-5"></i>
                                    <span class="fs-5">Manage Blog</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="blogmanage?action=addblog">
                                    <i class="fas fa-fw fa-palette fs-5"></i>
                                    <span class="fs-5">Add Blog</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row gx-5">
                                                <div class="col-lg-8 container-fluid">
                                                    <form action="blogmanage?action=update&blog_id=${blog.id}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="mb-3 p-3 border bg-light row">
                                                        <div class="mb-3 col-lg-6">
                                                            ...
                                                            <div class="form-check">
                                                                <input class="" type="radio" name="featured" id="credit" value="true" >
                                            ...
                                            <div class="col-lg-4 container-fluid">
                                                <form action="blogmanage?action=editimage&blog_id=${blog.id}" method="POST" enctype="multipart/form-data">
                                                    <div class="mb-3 p-3 border bg-light">
