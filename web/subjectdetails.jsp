                ...
                <div class="container-fluid">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="overview" role="tabpanel" aria-labelledby="overview-tab">
                            <form enctype="multipart/form-data" class="was-validated" method="post" action="subjectdetails?action=update&id=${course.id}">
                                <div class="mt-4 row">
                                    ...
                                    <div class="col-7">
                                        ...
                                        <div class="mb-3">
                                            <div class=" position-relative">
                                                ...
                                                <input type="text" class="form-control" id="subjectname" name="coursename" value="${course.name}" required>
                                        ...
                                        <div class="mb-3">
                                            <div class=" position-relative">
                                                ...
                                                <input type="text" class="form-control" id="tagline" name="tagline" value="${course.tagline}" required>
                                            ...
                                            <div>
                                                ...
                                                <div class="d-flex mt-2 ml-2">
                                                    ...
                                                    <div class="form-check">
                                                        <input type="radio" class="form-check-input" id="yes" name="featuredsubject"
                                                    ...
                                                    <div class="form-check mb-3 mx-4 px-2">
                                                        <input type="radio" class="form-check-input" id="no" name="featuredsubject"
                                        ...
                                        <label class="pointer" for="thumbnail">
                                            ...
                                            <div class="thumbnail">
                                                ...
                                                <div class="thumbnail__content">
                                                    ...
                                                    <span class="thumbnail__text">Update Thumbnail</span>
                                                </div>

                                            </div>
                                        </label>
                                        <input type="file" id="thumbnail" name="thumbnail" accept="image/png, image/jpeg" onchange="loadFile(event)">
                        ...
                        <div class="tab-pane" id="dimension" role="tabpanel" aria-labelledby="dimension-tab">
                            ...
                            <div class="modal fade" id="newdimension" tabindex="-1" role="dialog" aria-labelledby="newdimension" aria-hidden="true">
                                <form method="post" action="subjectdetails?action=addnewdimesnsion&id=${course.id}">  <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body my-5">
                                                Type - Name
                                                <select name="addmultidimension" id="choices-multiple-remove-button" placeholder="Select new dimension" multiple>

                                                    <c:forEach items="${addnewdimension}" var="a">


                                                        <option value="${a.id}" title="lalala">${a.type} - ${a.name}</option>
                                    ...
                                    <table class="table table-bordered table-hover  " style=" margin-bottom: 0px; font-size: 15px; " > 
                                        ...
                                        <c:forEach items="${course.dimension}" var="a">
                                            <tr>
                                                ...
                                                <td >
                                                    <span alt="Change this status"  class="mr-2"><a href="#" data-bs-toggle="modal" data-bs-target="#viewdimension${a.id}" >  <i class="fa-solid fa-eye"></i> View </a></span>
                                                    <span alt="Change this status"  class="mr-2"><a href="#" data-bs-toggle="modal" data-bs-target="#edit${a.id}" >  <i class="fa-solid fa-pen-to-square"></i> Edit </a></span>
                                                    ...
                                                    <div class="modal fade" id="edit${a.id}" tabindex="-1" role="dialog" aria-labelledby="#deletedimension${a.id}" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <form method="post" action="subjectdetails?action=editdimension&id=${course.id}&did=${a.id}">
                                                                    <div class="modal-body">
                    ...
                    <c:if test="${sessionScope.account.role.name eq 'Admin'}">
                        <div class="tab-pane" id="pricepkg" role="tabpanel" aria-labelledby="pricepkg-tab">   
                            ...
                            <div class="mb-3 mt-3 float-right">
                                <button class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#newpricepackage" type="submit">Add new</button>
                            </div>
                            <!-- Modal -->
                                        ...
                                        <c:forEach items="${course.pricepackages}" var="a">
                                            <tr>
                                                ...
                                                <td >
                                                    ...
                                                    <div class="modal fade" id="deleteprice${a.id}" tabindex="-1" role="dialog" aria-labelledby="#deleteprice${a.id}" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                                                    <a class="btn btn-primary"  href="subjectdetails?action=deletepricepackage&id=${course.id}&pid=${a.id}">Save changes</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>                                             
...
<script>
    ...
    var page_type = urlParams.get('part');
    part = document.getElementById(page_type);
    parttab = document.getElementById(page_type + '-tab');
    console.log(page_type);
    part.className = "tab-pane active";
    parttab.className = "nav-link active";

    if (page_type == 'dimension')
    {

        document.getElementById('overview-tab').className = "nav-link";
        document.getElementById('overview').className = "tab-pane";
    }
    if (page_type == 'pricepkg')
    {
