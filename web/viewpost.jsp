                            ...
                            <div class="col-md-12 m-5">
                                <div class="card_1">
                                    <div class="modal-header border-bottom p-3">
                                        <h5 class="text-warning modal-title" id="exampleModalLabel">Post</h5>
                                        <div>
                                            <a href="postlist" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Back to List</a>
                                            <a href="editpost?blogid=${blog.id}" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Edit</a>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="row gx-5">
                                            <div class="col-lg-8 container-fluid">
                                                <div class="p-3 border bg-light">
                                                    <div class="mb-3">
                                                        ...
                                                        <input value="${blog.title}" name="title" id="name" type="text" class="form-control" readonly>
                                                    </div>

                                                    <div class="mb-3">
                                                        <label class="form-label h5">Post content <span class="text-danger">*</span></label>
                                                        <textarea rows="10" cols="70" id="describe" name="describe" class="form-control" readonly="">
                                                            ${blog.description}
                                                        </textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 p-3 border bg-light">
                                                    ...
                                                    <textarea rows="" cols="" id="brief" name="brief" class="form-control" style="width: 720px; height:50px" readonly="">
                                                        ${blog.brief}
                                                    </textarea>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 container-fluid">
                                                <div class="mb-3 p-3 border bg-light">
                                                    ...
                                                    <input value="${blog.categoryblog.name}" name="title" id="name" type="text" class="form-control" readonly>
                                                </div>
                                                <div class="mb-3 p-3 border bg-light">
                                                ...
                                                <div class="p-3 border bg-light">
                                                    <div class="mb-3">
                                                        <label class="form-label h6">Feature Post <span class="text-danger"></span></label>
                                                        <div class="form-check" style="display: inline-block">
                                                            <input class="form-check-inpu" type="checkbox" name="featured" id="credit" 
                                                                   <c:if test="${requestScope.blog.flag == true}">checked="checked"</c:if> disabled="disabled">
                                                        </div>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label h6">Visibility <span class="text-danger"></span></label>
                                                        <div class="form-check">
                                                            <input class="" type="radio" name="status" id="credit" value="true" 
                                                            <c:if test="${requestScope.blog.status == true}">checked="checked" </c:if> disabled="disabled">
                                                        ...
                                                        <div class="form-check">
                                                            ...
                                                            <c:if test="${requestScope.blog.status == false}">checked="checked"</c:if> disabled="disabled">
                                                            <label class="form-check-label">
                                                                Hidden
                                                            </label>
                                                        </div>
